...
R1_stairs = subplaceable.Door_up('R1_stairs', Coord(1,(1594,516)), Surface((335,220)))
R1_stairs_down = subplaceable.Door_down('R1_stairs_down', Coord(1,(1594,516 + 33*6)), Surface((335,220)))
...
R2_stairs = subplaceable.Door_up('R2_stairs', Coord(2,(1594,516)), Surface((335,220)))
R2_stairs_down = subplaceable.Door_down('R2_stairs_down', Coord(2,(1594,516 + 33*6)), Surface((335,220)))
